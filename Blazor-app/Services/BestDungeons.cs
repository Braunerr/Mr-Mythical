...
public class BestDungeons
{
    ...
    public List<MythicPlusRun> mythic_plus_best_runs { get; set; }
}

public class AlternateDungeons
{
    public string name { get; set; }
    public string race { get; set; }
    public string @class { get; set; }
    ...
    public string profile_url { get; set; }
    public string profile_banner { get; set; }
    public List<MythicPlusRun> mythic_plus_alternate_runs { get; set; }
}
